                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm text-gray-300">
                                <li><Link href="/marketplace/help" className="hover:text-white">Bantuan</Link></li>
                                <li><Link href="/marketplace/shipping" className="hover:text-white">Pengiriman</Link></li>
                                <li><Link href="/marketplace/returns" className="hover:text-white">Retur</Link></li>
                                <li><Link href="/marketplace/contact" className="hover:text-white">Kontak</Link></li>
                            </ul>
                        </div>
                        <div>
                            <h3 className="text-lg font-semibold mb-4">Akun</h3>
                            <ul className="space-y-2 text-sm text-gray-300">
                                <li><Link href="/marketplace/profile" className="hover:text-white">Profil Saya</Link></li>
                                <li><Link href="/marketplace/orders" className="hover:text-white">Pesanan</Link></li>
                                <li><Link href="/marketplace/wishlist" className="hover:text-white">Wishlist</Link></li>
                                <li><Link href="/marketplace/settings" className="hover:text-white">Pengaturan</Link></li>
                            </ul>
                        </div>
                        <div>
