                    ...
                    <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
                            ...
                            <div className="justify-content-end">
                                ...
                                <ul className="space-y-2 text-sm text-gray-400">
                                    <li className="flex items-center space-x-3"><Package className="h-5 w-5" /><Link href="/orders" className="hover:text-gray-200 text-lg">Pesanan Saya</Link></li>
                                    <li className="flex items-center space-x-3"><ShoppingCart className="h-5 w-5" /><Link href="/cart" className="hover:text-gray-200 text-lg">Keranjang</Link></li>
                                </ul>
                            </div>
                            <div>
