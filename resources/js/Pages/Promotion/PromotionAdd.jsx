    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            Swal.fire({
                icon: 'error',
                title: 'Gagal!',
                text: err.response?.data?.message || 'Gagal menambahkan promosi'
            });
        } finally {
            setLoading(false);
        }
        ...
        <DashboardLayout>
            <div className="p-6">
                ...
                <div className="mb-6">
                    ...
                    <h1 className="text-2xl font-bold text-gray-800 mb-2">Tambah Promosi</h1>
                    <p className="text-gray-600">Buat promosi atau informasi diskon baru</p>
                </div>
