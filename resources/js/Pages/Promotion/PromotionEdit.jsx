                    ...
                    <div className="bg-white rounded-lg shadow-sm p-6 space-y-6">
                        ...
                        <div className="flex gap-3 pt-4">
                            ...
                            <button
                                ...
                                onClick={handleCancel}
                                disabled={loading}
                                className="flex-1 px-6 py-2.5 border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                            >
                                Batal
                            </button>
